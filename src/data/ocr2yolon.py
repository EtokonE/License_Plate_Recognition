...
PATH = '/media/max/Transcend/max/plate_recognition/licence_plate_recognition/data/raw/plate_detection_external_datasets/data/ocr_yolo/data/train/'
...
def parse_ann_file(raw_annotation: str) -> [YoloAnnotationXYWH]:
